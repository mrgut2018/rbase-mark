...
class AcademicTranslator(BaseAgent):
    ...
    def translate(self, text: str, target_lang: str, user_dict: List[dict] = None, extra_info: str = "") -> str:
        """
        ...
        Args:
            ...
            extra_info: Extra information to be added to the translation prompt
        ...
        extra_info = extra_info if extra_info else "If a word has multiple meanings, we prefer the meaning in the biomedical field."
